...
check P3a 200 GET "/learn?role=common"
check P3b 200 GET "/learn?role=papa"
check P3c 200 GET "/learn?role=mama"
check P3d 200 GET "/learn?role=kids"
check P3e 200 GET "/learn?role=senior"
check P4a 200 GET "/learn?cat=image-gen"
check P4b 200 GET "/learn?cat=image-gen&cat=voice"
check P4c 200 GET "/learn?cat=education"
check P4d 200 GET "/learn?cat=housework"
...
check F2  200 GET "/api/articles?role=papa"
check F3  200 GET "/api/articles?cat=image-gen&cat=voice"
