...
check P3a 200 GET "/learn"
check P3b 200 GET "/learn?cat=education"
check P3c 200 GET "/learn?cat=voice"
check P3d 200 GET "/learn?level=beginner"
check P3e 200 GET "/learn?sort=popular"
