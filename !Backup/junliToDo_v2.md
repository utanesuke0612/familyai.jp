...
| タイミング | 項目 | 費用 |
|---|---|---|
| 毎月 | Vercel・Neon・Blob（無料枠内） | 0円 |
| 毎月 | ドメイン按分 | 約200円 |
| Phase 2〜 | AI API使用料（Gemini・Claude・Whisper） | 約100〜1,000円/月 |
...
```
① GitHub アカウント作成（無料・5分）
② Vercel アカウント作成（無料・10分）
③ Neon アカウント作成（無料・クレカ不要・10分）
④ Google Cloud → OAuth 同意画面 → クライアントID作成（20〜30分）
⑤ AI APIキー取得（Anthropic・Google・OpenAI）（各10分）
⑥ ドメインのDNS設定（Vercelにドメイン追加後・30分）
```
