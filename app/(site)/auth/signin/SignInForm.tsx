...
/**
 * app/(site)/auth/signin/SignInForm.tsx
 * familyai.jp — ログインフォーム本体（Client Component）
 *
 * P2 #5: page.tsx から `useSearchParams()` 利用部分を切り出して、
 *        page.tsx 側を Server Component + <Suspense> ラップにできるようにした。
 *        これで CSR bail-out がログインカードの範囲だけに閉じ込められる。
 */
